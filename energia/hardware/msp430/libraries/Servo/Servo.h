...
#define MIN_PULSE_WIDTH      1235     // the shortest pulse sent to a servo [uS]
#define MAX_PULSE_WIDTH      2000     // the longest pulse sent to a servo [uS]
#define DEFAULT_PULSE_WIDTH  1500    // default pulse width when servo is attached
#define REFRESH_INTERVAL     12000     // servos refresh period in microseconds
